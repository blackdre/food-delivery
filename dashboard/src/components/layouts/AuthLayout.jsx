      ...
      <div
        ...
        <div className='offcanvas-header'>
          <div className='d-flex align-items-center'>
            <h3 className='offcanvas-title me-3' id='offcanvasExampleLabel'>
              Settings
            </h3>
          </div>
          <button
          ...
          <div className='row'>
            <div className='col-lg-12'>
              ...
              <div className='grid-cols-5 mb-4 d-grid gap-x-2'>
                <div
                  className='btn btn-border bg-transparent'
                  ...
                  <svg
                    className='customizer-btn icon-32'
                    xmlns='http://www.w3.org/2000/svg'
                    viewBox='0 0 24 24'
                    width='32'>
              ...
              <hr className='hr-horizontal' />
              <h5 className='mb-3 mt-4'>Scheme Direction</h5>
              <div className='d-grid gap-3 grid-cols-2 mb-4'>
                <div className='text-center'>
                  <img
                    src='../../assets/images/settings/dark/01.png'
                    alt='ltr'
                    className='mode dark-img img-fluid btn-border p-0 flex-column active mb-2'
                  ...
                  <img
                    ...
                    alt='ltr'
                    className='mode light-img img-fluid btn-border p-0 flex-column active mb-2'
                    data-setting='dir-mode'
                    data-name='dir'
                    data-value='ltr'
                  />
                ...
                <div className='text-center'>
                  <img
                    ...
                    alt=''
                    className='mode dark-img img-fluid btn-border p-0 flex-column mb-2'
                    data-setting='dir-mode'
                    data-name='dir'
                    data-value='rtl'
                  />
                  <img
                    ...
                    alt=''
                    className='mode light-img img-fluid btn-border p-0 flex-column mb-2'
                    data-setting='dir-mode'
                    data-name='dir'
                    data-value='rtl'
                  />
              ...
              <div className='d-grid gap-3 grid-cols-2 mb-4'>
                <div
                  className='btn btn-border d-block'
              ...
              <div className='d-grid gap-3 grid-cols-2 mb-4'>
                ...
                <div className='text-center'>
                  <img
                    ...
                    alt='pill-all'
                    className='mode dark-img img-fluid btn-border p-0 flex-column'
                    data-setting='sidebar'
                    data-name='sidebar-item'
              ...
              <div className='d-grid gap-3 grid-cols-2 '>
                ...
                <div
                  className='btn btn-border active col-span-full mt-4 d-block'
                  data-setting='navbar'
                  data-name='navbar-default'
                  data-value='default'>
                  <span className=''> Default Navbar</span>
                </div>
              </div>
            </div>
          </div>
