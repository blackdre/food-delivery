                        ...
                        <div className='col-sm-6 col-md-4 col-xl mb-5 h-100'>
                          <div className='card card-span h-100 rounded-3'>
                            ...
                            <div className='card-body ps-0'>
                              ...
                              <span className='text-1000 fw-bold'>R3.88</span>
                            </div>
                          </div>
                        ...
                        <div className='col-sm-6 col-md-4 col-xl mb-5 h-100'>
                          <div className='card card-span h-100 rounded-3'>
                            ...
                            <div className='card-body ps-0'>
                              ...
                              <span className='text-1000 fw-bold'>R4.00</span>
                            </div>
                          </div>
                          <div className='d-grid gap-2'>
                            <a
                        ...
                        <div className='col-sm-6 col-md-4 col-xl mb-5 h-100'>
                          <div className='card card-span h-100 rounded-3'>
                            ...
                            <div className='card-body ps-0'>
                              ...
                              <span className='text-1000 fw-bold'>R1.99</span>
                            </div>
                          </div>
                          <div className='d-grid gap-2'>
                            <a
                        ...
                        <div className='col-sm-6 col-md-4 col-xl mb-5 h-100'>
                          <div className='card card-span h-100 rounded-3'>
                            ...
                            <div className='card-body ps-0'>
                              ...
                              <span className='text-1000 fw-bold'>R3.00</span>
                            </div>
                          </div>
                          <div className='d-grid gap-2'>
                            <a
                        ...
                        <div className='col-sm-6 col-md-4 col-xl mb-5 h-100'>
                          <div className='card card-span h-100 rounded-3'>
                            ...
                            <div className='card-body ps-0'>
                              ...
                              <span className='text-1000 fw-bold'>R2.79</span>
                            </div>
                          </div>
                          <div className='d-grid gap-2'>
                            <a
            ...
            <div className='row'>
              ...
              <div className='col-12 col-md-8 col-lg-6 col-xxl-4'>
                ...
                <div className='text-start my-3'>
                  ...
                  <a href='#!'>
                    <svg
                      className='svg-inline--fa fa-instagram fa-w-14 fs-2 me-2'
                      aria-hidden='true'
                      focusable='false'
                      data-prefix='fab'
                      data-icon='instagram'
